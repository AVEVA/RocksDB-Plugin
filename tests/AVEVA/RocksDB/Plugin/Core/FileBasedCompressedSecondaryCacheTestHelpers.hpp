...
inline std::shared_ptr<boost::log::sources::severity_logger_mt<boost::log::trivial::severity_level>> MakeNullLogger() {
...
size_t TestSizeCb(rocksdb::Cache::ObjectPtr obj) { return static_cast<TestPayload*>(obj)->data.size(); }

rocksdb::Status TestSaveToCb(rocksdb::Cache::ObjectPtr obj, size_t from_offset, size_t length, char* out_buf) {
...
rocksdb::Status TestCreateCb(const rocksdb::Slice& data, rocksdb::CompressionType /*type*/,
                             rocksdb::CacheTier /*source*/, rocksdb::Cache::CreateContext* /*ctx*/,
                             rocksdb::MemoryAllocator* /*alloc*/, rocksdb::Cache::ObjectPtr* out_obj,
                             size_t* out_charge) {
...
void TestDeleteCb(rocksdb::Cache::ObjectPtr obj, rocksdb::MemoryAllocator*) { delete static_cast<TestPayload*>(obj); }

// Returns a temporary directory that is removed when the test fixture tears down.
std::filesystem::path MakeTempDir(const std::string& suffix) {
    auto base = std::filesystem::temp_directory_path() / ("aveva_sec_cache_test_" + suffix);
...
[[maybe_unused]] rocksdb::CompressionType g_capturedCompressionType = rocksdb::CompressionType::kNoCompression;

[[maybe_unused]] rocksdb::Status CapturingCreateCb(const rocksdb::Slice& data, rocksdb::CompressionType type,
                                                   rocksdb::CacheTier /*source*/,
                                                   rocksdb::Cache::CreateContext* /*ctx*/,
                                                   rocksdb::MemoryAllocator* /*alloc*/,
                                                   rocksdb::Cache::ObjectPtr* out_obj, size_t* out_charge) {
