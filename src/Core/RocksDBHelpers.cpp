...
bool RocksDBHelpers::IsManifestFile(const std::string_view pathname) { return IsFile(pathname, "MANIFEST"); }

bool RocksDBHelpers::IsIdentityFile(const std::string_view pathname) { return IsFile(pathname, "IDENTITY"); }
