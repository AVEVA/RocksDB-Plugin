...
LocalFile::LocalFile(const std::filesystem::path& path) : m_file(path, std::ios::in | std::ios::binary) {}

int64_t LocalFile::Read(char* buffer, int64_t offset, int64_t length) {
