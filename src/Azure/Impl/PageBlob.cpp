...
PageBlob::PageBlob(::Azure::Storage::Blobs::PageBlobClient client) : m_client(std::move(client)) {}
...
void PageBlob::SetCapacity(int64_t capacity) { m_client.Resize(capacity); }
...
int64_t PageBlob::DownloadTo(std::span<char> buffer, int64_t offset, int64_t length) {
    ::Azure::Storage::Blobs::DownloadBlobToOptions options{.Range = ::Azure::Core::Http::HttpRange{offset, length}};
...
int64_t PageBlob::Download(std::span<char> buffer, int64_t offset, int64_t length, const ::Azure::ETag& ifMatch) {
    ::Azure::Storage::Blobs::DownloadBlobOptions options{.Range = ::Azure::Core::Http::HttpRange{offset, length}};
