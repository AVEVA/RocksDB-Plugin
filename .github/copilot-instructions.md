...
2. Read [.github/PULL_REQUEST_TEMPLATE.md](PULL_REQUEST_TEMPLATE.md) **before** composing the
   PR description.
3. Populate all template sections: summary, verification, risk/rollback, and the checklist.
